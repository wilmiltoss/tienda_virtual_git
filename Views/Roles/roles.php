<?php   
  ...
  getModal('modalRoles',$data); // llama a la funcion getModal del Heplpers/helpers.php( que a su vez muestra el modals creados en Views o sea lo que contiene en modalsRoles.php su vista en html)
 ?>
